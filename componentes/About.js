  ...
  return (
    <div>
      ...
      <div className='TechnicalSkills'>
        <p>Material UI <small className="years">0-1 year</small></p>
        <p>Expo <small className="years">0-1 year</small></p>
        <p>React Native <small className="years">1 year</small></p>
        <p>Pusher <small className="years">0-1 year</small></p>
        <p>TypeScript <small className="years">1 year</small></p>
        <p>CSS3 <small className="years">4 years</small></p>
        <p>HTML5 <small className="years">4 years</small></p>
        ...
        <p>PHP <small className="years">2 year</small></p>
        ...
        <p>Sass <small className="years">2 years</small></p>
        <p>Gulp <small className="years">2 years</small></p>
        <p>JWT <small className="years">2 year</small></p>
        ...
        <p>MongoDb <small className="years">2 year</small></p>
